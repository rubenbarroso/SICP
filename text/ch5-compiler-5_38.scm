...
(load "text/ch5-syntax-5_38.scm")			;section 4.1.2 syntax procedures
...
;a
(define (spread-arguments operator operand1 operand2 target linkage)
  (let ((c-operand1 (compile operand1 'arg1 'next))
        (c-operand2 (compile operand2 'arg2 'next)))
    (end-with-linkage 
     linkage
